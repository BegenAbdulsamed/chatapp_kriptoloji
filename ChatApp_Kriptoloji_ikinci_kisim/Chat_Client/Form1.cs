...
namespace Chat_Client
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            cmbSifreleme.Items.Add("Manuel AES"); // Zorunlu
            cmbSifreleme.Items.Add("Lib AES");
            cmbSifreleme.Items.Add("Lib DES");
            cmbSifreleme.Items.Add("Lib RSA");    // Wireshark'ta büyük paket
            cmbSifreleme.Items.Add("Lib ECC");    // Wireshark'ta küçük paket
            cmbSifreleme.SelectedIndex = 0;
        }
